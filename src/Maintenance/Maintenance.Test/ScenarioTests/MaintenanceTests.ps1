...
function Test-AzMaintenanceConfigurationInGuestPatch
{
    ...
    try
    {
        ...
        Assert-AreEqual $maintenanceConfigurationCreated1.RecurEvery $RecurEvery
        Assert-AreEqual $maintenanceConfigurationCreated1.Timezone $Timezone
        Assert-AreEqual $maintenanceConfigurationCreated1.InstallPatches.RebootSetting $RebootOption
        Assert-AreEqual $maintenanceConfigurationCreated1.InstallPatches.WindowsParameters.ClassificationsToInclude.Count 2
        Assert-True { $maintenanceConfigurationCreated1.InstallPatches.WindowsParameters.ClassificationsToInclude.Contains("FeaturePack") }
        Assert-True { $maintenanceConfigurationCreated1.InstallPatches.WindowsParameters.ClassificationsToInclude.Contains("ServicePack") }
        Assert-AreEqual $maintenanceConfigurationCreated1.InstallPatches.LinuxParameters.ClassificationsToInclude.Count 1
        Assert-True { $maintenanceConfigurationCreated1.InstallPatches.LinuxParameters.ClassificationsToInclude.Contains("Other") }
